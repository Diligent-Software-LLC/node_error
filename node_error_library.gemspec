...
Gem::Specification.new do |spec|
  ...
  spec.summary               = %q{A NodeError library. Organizes the
NodeError components.}
  spec.description           = %q{A NodeError library. Organizes the
NodeError components. Donations support continuous improvement and
...
available at $1, $2, $4, $8, and $16. Greatly appreciated.}
  ...
  spec.add_runtime_dependency 'node_error_int', '~> 2'
  spec.add_runtime_dependency 'node_error_impl', '~> 2'
